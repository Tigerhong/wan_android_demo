      ...
      children: <Widget>[
        ...
        Expanded(
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                title: Text(
                    Language.getString(context).switch_theme()),
                leading: new CircleAvatar(
                  backgroundColor: itemColor,
              ...
              ListTile(
                title: Text(
                    Language.getString(context).switch_language()),
                leading: new CircleAvatar(
                  backgroundColor: itemColor,
        ...
        Container(
          ...
          child: RaisedButton(
            ...
            child: Text(
                "${User().isLogin() ? Language.getString(context).logout()
                    : Language.getString(context).login()}"),
          ),
        )
      ],
    )));
